...
<section class="content-section text-white signup" id="signup" style="height: 100vh">
    <div class="container">
        <div class="content-section-heading text-center">
            <h2 class="mb-5">Recover password</h2>
        </div>
        <div>
            <form>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input label="" maxlength="150" name="email" type="tel" class="form-control" value="">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-md-3"></div>
                ...
                <div class="text-center mt-3">
                    ...
                    <a href="main.php" class="btn btn-outline-primary mx-2">Cancel</a> </div>
                <div class="row">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div class="my-5" style="font-size: 1rem">If you no longer use the e-mail or mobile number associated with your DrumText.com account, contact <a href="mailto:">Customer Service</a> for help restoring access to your account.</div>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </form>
